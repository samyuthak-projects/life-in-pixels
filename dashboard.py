...
class Dashboard:
    def __init__(self, username):
        ...
        self.subtitle = ctk.CTkLabel(self.scrollable_frame, text="Welcome back to Life in Pixels", font=("Helvetica", 18))
        self.subtitle.pack(pady=10)

        self.mood_title = ctk.CTkLabel(self.scrollable_frame, text="How are you feeling today?", font=ctk.CTkFont("Helvetica", 20, weight="bold"))
        self.mood_title.pack(pady=20)

        self.mood_frame = ctk.CTkFrame(self.scrollable_frame)
        ...
        self.streak_label = ctk.CTkLabel(self.scrollable_frame, text="🔥 Streak: 0 days", font=("Helvetica", 18, "bold"))
        self.streak_label.pack(pady=10)

        self.pixel_title = ctk.CTkLabel(self.scrollable_frame, text="Your Mood in Pixels", font=ctk.CTkFont("Helvetica", 22, weight="bold"))
        self.pixel_title.pack(pady=20)

        self.pixel_frame = ctk.CTkFrame(self.scrollable_frame, fg_color="#1f1f1f")
